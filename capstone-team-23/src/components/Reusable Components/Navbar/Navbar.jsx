...
function Navbar(props) {
  return (
    <div className='mainContainer-SignUpPage'>
        <nav class="navbar navbar-expand-lg navbar-light bg-light flex-navbar navbar-custom justify-content-end fixed-top py-4 ">
  <a class="navbar-brand" href="#"><CompanyLogo className="companyLogo" /></a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="collapse navbar-collapse justify-content-en flex-nav " id="navbarNav">
    <ul class="navbar-nav ">
      <li class="nav-item">
